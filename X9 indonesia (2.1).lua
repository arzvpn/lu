...
" =>  V2RAY/TROJAN",
" =>  Membuang",
" ❌  Keluar "},nil, (_G["os"]["date"]([[
Renzy
Tanggal Hari ini %d/%m/%Y
Jam %H:%M:%S

☠️  Pilih Metode Sniff:]])))
...
elseif ehi.tunnelType == "direct_shadowsocks" then
      ...
      message = message .. "ʀᴇᴀᴅ ᴄᴏɴꜰɪɢ ʙʏ ꜱᴇᴀ🌊 𝙏𝙪𝙣𝙣𝙚𝙡 𝙏𝙮𝙥𝙚: " .. Http:TunnelType() .. [[
...
function ehievozi()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: configExpiryTimest")
    ehi_2 = true
  end
  gg.searchNumber("h 7B 22 63 6F 6E 66 69 67 45 78 70 69 72 79 54 69 6D 65 73 74", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
    local r = gg.getResults(1)
    ...
    if ehi_2 then
        ...
        local r = gg.getResults(1)
        if #r < 1 then
        gg.toast("Pencarian Gagal ❌: V2rTlsAlpn")
      print([[
...
calma barboleta]])
  ...
  if ehi_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: configIdentifier")
      print([[
...
elseif app == "com.evozi.injector.lite" then
  ...
  gg.toast("Jangan Perlihatkan Padaku")
...
function HTTPCustom()
  ...
  if hc_8 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: Upgrade")
      hc_9 = true
    end
  end
  if hc_9 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: splitPsiphon splitPsiphon")
      hc_10 = true
    end
  end
  if hc_10 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: config for OpenVPN 2x")
      hc_11 = true
    end
  end
  if hc_11 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: splitConfig")
      hc_12 = true
    end
  end
  if hc_12 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: isLoginHwid")
      hc_13 = true
    end
  end
  if hc_13 then
  ...
  if hc_14 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: crlf Host")
      hc_15 = true
    end
  end
  if hc_15 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: inbound")
      hc_16 = true
    end
  end
  if hc_16 then
  ...
  if hc_17 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: ACL HTTP")
      hc_18 = true
    end
  end
  if hc_18 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: CONNECT")
      hc_19 = true
    end
  end
  if hc_19 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: rotate")
      hc_20 = true
    end
  end
  if hc_20 then
...
function hc_ssc()
  ...
  if ssc_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: dns hosts")
      ssc_6 = true
    end
  end
  if ssc_6 then
...
function TLSTunnel()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: versi")
    tls_2 = true
  end
  if tls_2 then
    limit = false
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: 359 h")
      tls_3 = true
    end
  end
  if tls_3 then
  ...
  if tls_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: cipher1 doFinal crypto")
      tls_6 = true
    end
  end
  if tls_6 then
  ...
  if tls_8 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: GET ws")
      tls_9 = true
    end
  end
  if tls_9 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: GET shi")
      tls_10 = true
    end
  end
  if tls_10 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: host crlf")
      tls_11 = true
    end
  end
  if tls_11 then
...
function eV2ray()
  ...
  if epro_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: aspas outbounds")
      epro_4 = true
    end
  end
  if epro_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: apsas inbounds")
      epro_5 = true
    end
  end
  if epro_5 then
...
function NapsternetV()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: versioning")
    npv_2 = true
  end
  if npv_2 then
    gg.searchNumber("h 55 70 67 72 61 64 65 3A", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
  ...
  if npv_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: psiphonConfig")
      npv_5 = true
    end
  end
  if npv_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: versioning e")
      npv_6 = true
    end
  end
  if npv_6 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: versioning configType")
      npv_7 = true
    end
  end
  if npv_7 then
...
function HATunnel()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: user id")
    hat_2 = true
  end
  if hat_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: connecion mode")
      hat_3 = true
    end
  end
  if hat_3 then
  ...
  if hat_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: override primary host")
      hat_5 = true
    end
  end
  if hat_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: acess code")
      hat_6 = true
    end
  end
  if hat_6 then
...
function DarkTunnel()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: SshConfigLockedeSshConfig")
    dark_2 = true
  end
  if dark_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: SshConfigLockedÃ©SshConfig")
      dark_3 = true
    end
  end
  if dark_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: SshConfigLocked")
      dark_4 = true
    end
  end
  if dark_4 then
  ...
  if dark_7 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: Message")
      dark_8 = true
    end
  end
  if dark_8 then
...
function RezTunnel()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: install")
    rez_2 = true
  end
  if rez_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: PSInstall 1")
      rez_3 = true
    end
  end
  if rez_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: PSInstall 2")
      rez_4 = true
    end
  end
  if rez_4 then
  ...
  if rez_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: Version Config full")
      rez_6 = true
    end
  end
  if rez_6 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: SSHHost")
      rez_7 = true
    end
  end
  if rez_7 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: Version Upgrade")
      rez_8 = true
    end
  end
  if rez_8 then
...
function ApkCustom()
  ...
  if acm_7 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: splitPsiphon")
      acm_8 = true
    end
  end
  if acm_8 then
...
function SocksIP()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: network sip")
    sip_2 = true
  end
  if sip_2 then
    gg.searchNumber("h 55 70 67 72 61 64 65 3A", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
  ...
  if sip_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: sshocean")
      sip_4 = true
    end
  end
  if sip_4 then
  ...
  if sip_8 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: GET w")
      sip_9 = true
    end
  end
  if sip_9 then
...
function StarkVPN()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: config barra")
    stk_2 = true
  end
  if stk_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: config aspas")
      stk_3 = true
    end
  end
  if stk_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: connection mode")
      stk_4 = true
    end
  end
  if stk_4 then
...
limit = true
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: Version")
    json_2 = true
  end
  if json_2 then
    gg.searchNumber("h 7B 0A 20 20 20 20 22 56 65 72 73 69 6F 6E", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
  ...
  limit = false
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: version aspas")
      json_7 = true
    end
  end
  if json_7 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: version barra")
      json_8 = true
    end
  end
  if json_8 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: ReleaseNotes")
      json_9 = true
    end
  end
  if json_9 then
...
function TunnelCat()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: export D")
    cat_2 = true
  end
  if cat_2 then
    gg.searchNumber("h 7b 5c 22 65 78 70 6f 72 74 44 65 74 61 69 6c 73 5c 22", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: exportDetails")
      cat_3 = true
    end
  end
  if cat_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: exportDe")
      cat_4 = true
    end
  end
  if cat_4 then
...
function v2rayHybrid()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: addedtime")
    hy_2 = true
  end
  if hy_2 then
    gg.searchNumber("h 7b 5c 22 61 64 64 65 64 54 69 6d 65 5c 22", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: added Time")
      hy_3 = true
    end
  end
  if hy_3 then
...
function ARMod()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: alter id")
    armo_2 = true
  end
  if armo_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: alter")
      armo_3 = true
    end
  end
  if armo_3 then
...
function WeTunnel()
  ...
  if we_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌:  install 2")
      we_5 = true
    end
  end
  if we_5 then
...
function XrayPB()
  ...
  if pb_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: added")
      pb_3 = true
    end
  end
  if pb_3 then
...
function sopass()
  ...
  if efbd_2 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: Password barra")
      efbd_3 = true
    end
  end
  if efbd_3 then
...
function kobra()
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: servidores")
    kobras_2 = true
  end
  if kobras_2 then
...
function contahc()
  ...
  if hc_15 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: my id")
      hc_16 = true
    end
  end
  if hc_16 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: online")
      hc_17 = true
    end
  end
  if hc_17 then
  ...
  if hc_19 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: cloudfront")
      hc_20 = true
    end
  end
  if hc_20 then
...
limit = false
  ...
  if hc_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: connect crlf")
      hc_5 = true
    end
  end
  if hc_5 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: rotation")
      hc_6 = true
    end
  end
  if hc_6 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: random")
      hc_7 = true
    end
  end
  if hc_7 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: proxy connection")
      hc_8 = true
    end
  end
  if hc_8 then
  ...
  if hc_9 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: crlf esp")
      hc_10 = true
    end
  end
  if hc_10 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: protocol crlf")
      hc_11 = true
    end
  end
  if hc_11 then
  ...
  if hc_12 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: n crlf")
      hc_13 = true
    end
  end
  if hc_13 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: p u int")
      hc_14 = true
    end
  end
  if hc_14 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: exp 100 con")
      hc_15 = true
    end
  end
  if hc_15 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: lf split")
      hc_16 = true
    end
  end
  if hc_16 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: x online")
      hc_17 = true
    end
  end
  if hc_17 then
  ...
  if hc_18 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: netdata r split")
      hc_19 = true
    end
  end
  if hc_19 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: gov crlf")
      hc_20 = true
    end
  end
  if hc_20 then
...
limit = false
  ...
  if #r < 1 then
  gg.processResume()
    gg.toast("Pencarian Gagal ❌: ssh-connection")
    logins_2 = true
  end
  if logins_2 then
  limit = false
...
function v2json(data)
  ...
  local r = gg.getResults(1)
  if #r < 1 then
    gg.toast("Pencarian Gagal ❌: inbounds")
    hc_2 = true
  end
  if hc_2 then 
  ...
  if hc_3 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: dns t")
      hc_4 = true
    end
  end
  if hc_4 then
    ...
    local r = gg.getResults(1)
    if #r < 1 then
      gg.toast("Pencarian Gagal ❌: address")
      hc_5 = true
    end
  end
...
io.open(gg.EXT_STORAGE .. "/arfydk.txt", "w"):write(hexdecode2(readedMem2))
gg.toast("File Found ✓")
  print("✓ I got you Lionel Richie!\n\nThe file is at: /sdcard/arfydk.txt")
reconnect()
x9B()
prima()
end
...
gg.toast("Jangan Lupa Bahagia")
os.exit()
end

function x9P()
gg.toast("👻 TETAP SANTUY")
end
